// Node-RED node implementation for FlexDash widget WindPlot
...
module.exports = function (RED) {
  ...
  function WindPlot(config) {
    ...
    fd.initWidget(this, config, 'WindPlot')
  ...
  RED.nodes.registerType("wind-plot", WindPlot)
}
