// Node-RED node implementation for FlexDash widget ValueSequence
...
module.exports = function (RED) {
  ...
  function ValueSequence(config) {
    ...
    fd.initWidget(this, config, 'ValueSequence')
  ...
  RED.nodes.registerType("value-sequence", ValueSequence)
}
