// Node-RED node implementation for FlexDash widget SimpleTable
...
module.exports = function (RED) {
  ...
  function SimpleTable(config) {
    ...
    fd.initWidget(this, config, 'SimpleTable')
  ...
  RED.nodes.registerType("simple-table", SimpleTable)
}
