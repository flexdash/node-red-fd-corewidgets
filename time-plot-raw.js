// Node-RED node implementation for FlexDash widget TimePlotRaw
...
module.exports = function (RED) {
  ...
  function TimePlotRaw(config) {
    ...
    fd.initWidget(this, config, 'TimePlotRaw')
  ...
  RED.nodes.registerType("time-plot-raw", TimePlotRaw)
}
