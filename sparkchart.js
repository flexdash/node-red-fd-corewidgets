// Node-RED node implementation for FlexDash widget Sparkchart
...
module.exports = function (RED) {
  ...
  function Sparkchart(config) {
    ...
    fd.initWidget(this, config, 'Sparkchart')
  ...
  RED.nodes.registerType("sparkchart", Sparkchart)
}
