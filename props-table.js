// Node-RED node implementation for FlexDash widget PropsTable
...
module.exports = function (RED) {
  ...
  function PropsTable(config) {
    ...
    fd.initWidget(this, config, 'PropsTable')
  ...
  RED.nodes.registerType("props-table", PropsTable)
}
